...
<body>
    <section>
        <div class="top-menu-bar">
            <div class="nav-img">
                <a href="#" class="nav-left-img"><img src="../../styleguide/ikoner-2/User icon.svg" alt="User ikon, Health Trackr User ikon"></a>
            </div>
        ...
        <div class="row">
            <div class="colum">
                <div class="sundhedsperson">
                    <h5>Min Sundhedsperson</h5>
                    <img src="../../styleguide/ikoner-2/User icon - active grøn.svg" alt="#">
                </div>
            </div>
            <div class="colum">
                <div class="sundhedsperson">
