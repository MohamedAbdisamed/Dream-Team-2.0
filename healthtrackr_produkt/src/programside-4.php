...
<body style="background-image: url('../scss/img/bg-ly.png'); background-size: cover;">
    ...
    <div class="container-fluid pl-0 pr-0">
        <img src="../scss/img/træning-4.JPG" class="img-fluid w-100 pl-0 pr-0" alt="Responsive image">
    </div>
    <div style="background-color: #79c5b2;">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1>Udstræknings program 2</h1>
                </div>
                <div class="col-12">
                    <p>Ben & Knæ</p>
                </div>
                <div class="col-12">
                    <p>Denne øvelse er til folk med knæ, lår og skinnebens problemer eller smerter. Øvelsen strækker ud i musklerne omrking knæene, samt langs lår og skinneben, og giver derved lindring til smerte det. Denne øvelse anbefales til folk med højt aktivitets niveau, og ømme ben muskler, da den kan lindre dette og forbedre muskelerne på længere sigt. </p>
                    <div class="col-12">
                        <video id="video" style="display: none;" controls>
                            <source src=" ../scss/video/træning4.mp4" type="video/mp4">
                    ...
                    <div class="col-12 pt-4" style="display: flex;">
                        ...
                        <p class="train-text pl-3 pt-2">Varighed: 4 Minutter</p>
                    </div>
                    <div class="col-12 pt-4" style="display: flex;">
                        <span class="material-icons material-symbols-outlined">
                            fitness_center
        ...
        <script>
            ...
            h1.innerHTML = "Udstræknings program 2";
        </script>
        <script>
            function play() {
