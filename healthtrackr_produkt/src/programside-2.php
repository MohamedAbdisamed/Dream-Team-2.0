...
<body style="background-image: url('../scss/img/bg-ly.png'); background-size: cover;">
    ...
    <div class="container-fluid pl-0 pr-0">
        <img src="../scss/img/træning-2.JPG" class="img-fluid w-100 pl-0 pr-0" alt="Responsive image">
    </div>
        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-12 pt-4" style="display: flex;">
                    ...
                    <p class="train-text pl-3 pt-2">Varighed: 8 Minutter</p>
                </div>
                <div class="col-12 pt-4" style="display: flex;">
                    <span class="material-icons material-symbols-outlined">
                        fitness_center
                    </span>
                    <p class="train-text pl-3 pt-2">Udstyr: Elastik bånd</p>
                </div>
                <div class="row pt-5">
                    <div class="col-12">
